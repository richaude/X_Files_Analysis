...
#writeEntropy2([5], "valuesEntropySeason6")	
#writeDementia2([5], "valuesDementiaSeason6")
#writeRedundance([5], "valuesRedundancySeason6")
#writeSentences([0,1,2,3,4,5], "valuesSatzlaengenLower")
writeWordLengths([5], "valuesWortlaengenSeason6")
